...
(define expt-machine
  (make-machine
    ...
    '(start
       ...
       (save cont)
       (assign cont (label expt-continue))
...
; (set-register-contents! expt-machine 'v1 2)
; (set-register-contents! expt-machine 'v2 5)
; (start expt-machine)
; (display (get-register-contents expt-machine 'res))
