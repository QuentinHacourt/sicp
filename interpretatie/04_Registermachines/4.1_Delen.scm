...
;; (set-register-contents! deel-machine 'v1 14)
;; (set-register-contents! deel-machine 'v2 4)
;; (start deel-machine)
;; (display (get-register-contents deel-machine 'res))
